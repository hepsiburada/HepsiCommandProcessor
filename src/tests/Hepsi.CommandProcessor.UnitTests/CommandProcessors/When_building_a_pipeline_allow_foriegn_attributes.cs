...
{
    [TestFixture]
    public class When_building_a_pipeline_allow_foriegn_attributes
    {
        ...
        public void Setup()
        {
            ...
            registry.Register<TestCommand, TestObsoleteCommandHandler>();

            var container = new TinyIoCContainer();
            var handlerFactory = new TinyIoCHandlerFactory(container);
            container.Register<IHandleRequests<TestCommand>, TestObsoleteCommandHandler>();
        ...
        {
            TracePipeline().ToString().Should().Be("TestValidationHandler`1|TestObsoleteCommandHandler|TestLoggingHandler`1|");
        }
